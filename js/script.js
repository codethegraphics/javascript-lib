(function (root, factory, undefined) {
	if (typeof define === 'function' && define.amd) {
		...
		console.log("Hello, I am Window and Your Jouney is started.");
	...
	function (global) {
		...
		Graph.prototype.drawCircle = function(canvasSelector) {
			...
			var c = document.getElementById(canvasSelector);
			...
			var x0 = dimensions.x0, y0 = dimensions.y0;
